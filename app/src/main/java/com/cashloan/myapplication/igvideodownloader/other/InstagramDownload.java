...
import com.cashloan.myapplication.igvideodownloader.activity.VideoDownloadActivity;
...
public class InstagramDownload extends AsyncTask<String, Integer, String> {
    ...
    public InstagramDownload(Activity context, String mediaName, AlertDialog alertDialog, String edtPaste, String nameIns) {
    ...
    protected void onPostExecute(String str) {
        ...
        mContext.startActivity(new Intent(mContext, VideoDownloadActivity.class).putExtra("url",str).putExtra("link",edtPaste).putExtra("name",nameIns));
    }
